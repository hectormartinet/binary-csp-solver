...
if __name__ == "__main__":
    ...
    result = subprocess.Popen(['./run.exe', args.file,  args.rootSolveMethod, args.nodeSolveMethod,  args.varChooser,  args.valChooser,  args.verbosity, args.timeLimit, args.randomSeed, args.nbSolution, args.AllDifferent, "0", "0"], stdout=subprocess.PIPE, text=True)
