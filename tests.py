...
if __name__ == "__main__":
    ...
    for test in all_tests[1:]:
        ...
        file = parameters[0]
        print(file)
        result = subprocess.Popen(['./run.exe', './Tests/' + file,  parameters[1],  parameters[2],  parameters[3],  '1', parameters[4], parameters[5], parameters[6], parameters[7], parameters[8]], stdout=subprocess.PIPE, text=True, stderr=subprocess.PIPE)
